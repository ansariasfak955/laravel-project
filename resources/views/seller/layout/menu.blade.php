<div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="sidebar-heading text-center py-4 primary-text fs-4 fw-bold text-uppercase border-bottom">
                <i class="fas fa-user-secret me-2"></i> Seller Admin
            </div>
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="{{url('seller/category/add')}}" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class="fas fa-project-diagram me-2"></i> Add Category
                </a>
